...
import { NAVIGATE_TO_ABOUT, NAVIGATE_TO_ADMIN_PROFILE, NAVIGATE_TO_FAQ, NAVIGATE_TO_HOME, NAVIGATE_TO_LOGIN, NAVIGATE_TO_NEWS, NAVIGATE_TO_PRICING, NAVIGATE_TO_PROFILE, NAVIGATE_TO_REGISTER, NAVIGATE_TO_COMMUNITY_SUPPORT } from '../../constant/routeConstant'; // Make sure NAVIGATE_TO_COMMUNITY_SUPPORT is imported
                    ...
                    <div className="container-fluid" style={{ marginLeft: isMobile ? 0 : '15%', marginRight: isMobile ? 0 : '15%' }}>
                        ...
                        <div className="collapse navbar-collapse" id="navbarNav">
                            <ul className="navbar-nav ms-auto">
                                {/* **COMMUNITY SUPPORT BUTTON FOR ADMIN NAVBAR** */}
                                <li className="nav-item mt-1 text-center">
                                    <Link className="nav-link" to={NAVIGATE_TO_COMMUNITY_SUPPORT}>
                                        <h6 style={{ color: '#404040', fontWeight: 400 }}>Community Support</h6>
                                    </Link>
                                </li>
                                <li className="nav-item mt-1 text-center">
            ...
            {isInstructor && (
                <nav className="navbar navbar-expand-lg p-3 mb-5 navbar-dark custom-bg-color fixed-top">
                    <div className="container-fluid" style={{ marginLeft: isMobile ? 0 : '15%', marginRight: isMobile ? 0 : '15%' }}>
                        ...
                        <div className="collapse navbar-collapse" id="navbarNav">
                            <ul className="navbar-nav ms-auto">
                                {/* **COMMUNITY SUPPORT BUTTON FOR INSTRUCTOR NAVBAR** */}
                                <li className="nav-item mt-1 text-center">
                                    <Link className="nav-link" to={NAVIGATE_TO_COMMUNITY_SUPPORT}>
                                        <h6 style={{ color: '#404040', fontWeight: 400 }}>Community Support</h6>
                                    </Link>
                    ...
                    <div className="container-fluid" style={{ marginLeft: isMobile ? 0 : '15%', marginRight: isMobile ? 0 : '15%' }}>
                        ...
                        <div className="collapse navbar-collapse" id="navbarNav">
                            <ul className="navbar-nav ms-auto">
                                ...
                                {/* **COMMUNITY SUPPORT BUTTON FOR STUDENT NAVBAR** */}
                                <li className="nav-item mt-1 text-center">
                                    <Link className="nav-link" to={NAVIGATE_TO_COMMUNITY_SUPPORT}>
                                        <h6 style={{ color: '#404040', fontWeight: 400 }}>Community Support</h6>
                                    </Link>
                    ...
                    <div className="container-fluid" style={{ marginLeft: isMobile ? 0 : '15%', marginRight: isMobile ? 0 : '15%' }}>
                        ...
                        <div className="collapse navbar-collapse" id="navbarNav">
                            <ul className="navbar-nav ms-auto">
                                ...
                                {/* **COMMUNITY SUPPORT BUTTON FOR UNAUTHENTICATED NAVBAR** */}
                                <li className="nav-item mt-1 text-center">
                                    <Link className="nav-link" to={NAVIGATE_TO_COMMUNITY_SUPPORT}>
                                        <h6 style={{ color: '#404040', fontWeight: 400 }}>Community Support</h6>
                                    </Link>
